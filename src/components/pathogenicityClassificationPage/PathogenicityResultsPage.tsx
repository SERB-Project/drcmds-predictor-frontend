...
export function PathogenicityResultsPage() {
  ...
  return (
    <div className="p-8 bg-white dark:bg-[rgba(2,31,53,0.8)] rounded-lg border-2 border-[rgba(2,31,53,0.1)] dark:border-[rgba(255,255,255,0.1)]">
      ...
      {/* Prediction Result */}
      <div className="mb-8 p-6 bg-[rgba(2,31,53,0.05)] dark:bg-[rgba(2,31,53,0.3)] rounded-lg border-l-4 border-[rgba(2,31,53,1)]">
        <h3 className="text-xl font-semibold text-[rgba(2,31,53,1)] dark:text-white mb-2 text-left">
      ...
      <div className="space-y-4">
        <div className="bg-[rgba(2,31,53,0.05)] dark:bg-[rgba(2,31,53,0.3)] rounded-lg p-6">
          <h3 className="text-xl font-semibold text-[rgba(2,31,53,1)] dark:text-white mb-4 text-left">
            Variant Details
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* SPDI Information */}
            <div className="bg-white dark:bg-[rgba(2,31,53,0.2)] p-4 rounded-lg">
              <h4 className="text-sm font-medium text-[rgba(2,31,53,0.6)] dark:text-gray-400 mb-2">
                Canonical SPDI
              </h4>
              <p className="text-lg font-mono text-[rgba(2,31,53,1)] dark:text-white">
                {results.spdi}
              </p>
            </div>
